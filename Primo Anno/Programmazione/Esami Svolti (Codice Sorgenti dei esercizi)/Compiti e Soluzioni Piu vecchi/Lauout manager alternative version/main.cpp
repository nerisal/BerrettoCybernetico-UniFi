...
int main (){
	Button* bottone1= new Button("primo bottone");
	Button* bottone2= new Button("secondo bottone");
	TextArea* textArea1= new TextArea("prima text area");
	Button* bottone3= new Button("terzo bottone");
