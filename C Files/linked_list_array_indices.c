...
boolean pre_insert(
    struct LinkedList *ptr,
    int value) { /* se la lista libera non è vuota, ne sgancia il primo
                  * elemento, lo aggancia in testa alla lista dei valori e ci
                  * memorizza il valore da inserire */
    int moved;
...
boolean suf_insert(
    struct LinkedList *ptr,
    int value) { /* Se la lista libera non è vuota, ne sgancia il primo elemento
                  * e lo aggancia in coda alla lista dei valori, ci copia sopra
                  * il valore da inserire e attribuisce il valore illegale al
                  * successore*/
...
boolean ord_insert(
    struct LinkedList *ptr,
    int value) { /*assume che la lista sia ordinata, inserisce il nuovo elemento
                  * in ordine E' analoga alla funzione di inserimento in coda,
                  * salvo l'aggiunta di una seconda condizione sul while e uno
                  * swap nell' inserimento finale*/
